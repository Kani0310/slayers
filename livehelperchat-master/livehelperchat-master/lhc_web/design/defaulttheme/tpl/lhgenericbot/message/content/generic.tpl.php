                        ...
                        <ul class="bot-btn-list">
                            <?php foreach ($item['buttons'] as $itemButton) : ?>
                                <li>
                                    ...
                                    <a rel="noreferrer" target="_blank" <?php if (isset($itemButton['content']['payload_message']) && $itemButton['content']['payload_message'] != '') : ?>data-id="<?php echo $messageId?>" data-payload=<?php echo json_encode($itemButton['content']['payload_message']. '__' . md5($itemButton['content']['name']))?> onclick='lhinst.buttonClicked(<?php echo json_encode($itemButton['content']['payload_message']. '__' . md5($itemButton['content']['name']))?>,<?php echo $messageId?>,$(this))'<?php endif;?> href="<?php echo htmlspecialchars($itemButton['content']['payload'])?>">
